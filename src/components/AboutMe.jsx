...
const AboutMe = () => {
  return (
    <section className="relative w-full h-screen overflow-hidden bg-black border-t border-neutral-900/50">
          ...
          <div className='w-full md:w-1/2 max-w-lg space-y-6 order-1 md:order-1 md:ml-8 lg:ml-12'>
            ...
            <div className='relative'>
              ...
              <p className='text-white/50 text-sm sm:text-base leading-relaxed font-light'>
                ...
                Rem exercitationem cum illum? Soluta ex, architecto cupiditate
                tempora ab explicabo commodi recusandae quisquam mollitia pariatur
                minima necessitatibus similique nemo at autem?
              </p>
            </div>
